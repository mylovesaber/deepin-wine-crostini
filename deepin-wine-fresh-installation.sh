...
cd /root
apt install -y binutils:i386 multiarch-support:i386 linux-libc-dev:i386 binfmt-support p7zip p7zip-full python-dbus python-gobject libxt6:i386 gcc-8:i386 cpp:i386 gcc:i386 fonts-noto-cjk zenity zenity-common libnotify4 libwebkit2gtk-4.0-37
